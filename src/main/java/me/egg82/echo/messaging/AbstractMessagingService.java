...
public abstract class AbstractMessagingService implements MessagingService {
    ...
    protected final byte @NotNull [] compressData(ByteBuf data) throws IOException {
    ...
    protected final @NotNull ByteBuf decompressData(ByteBuf data) throws IOException {
        if (data == null || data.capacity() == 0) {
